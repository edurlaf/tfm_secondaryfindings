...
"""
"""
falta haer csv con assembly 38, y su bed y json correspondientes. También falta ver si funcioan bien.
"""
import os
import csv
import json
...
def generate_json_from_fg_csv(csv_file, assembly):
    ...
    try:
        ...
        # Write JSON file
        out_json = 'farmacogenetico_risk_genes_' + assembly + '.json'
...
def generate_bed_from_fg_csv(csv_file, assembly):
    ...
    try:
        ...
        bed_filename = f"farmacogenetico_variants_{assembly}.bed"
...
def get_json_bed_fg(assembly):
    ...
    """
    try:
        os.chdir("C:/Users/kindi/OneDrive/Escritorio/MASTER/M10/codigo/")
        csv_file = "farmacogenetico_risk_genes.csv"
        generate_json_from_fg_csv(csv_file, assembly)
    except Exception as e:
        print(f"An error occurred: {str(e)}")
